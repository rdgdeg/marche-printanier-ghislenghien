  ...
  if (submitted) {
    return (
      <div className="max-w-3xl mx-auto px-4 py-24 text-center">
        <div className="w-24 h-24 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-8 text-5xl">
          ✨
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button 
            ...
            className="text-blue-600 font-bold hover:underline transition-all hover:scale-105"
          >
            {t('registration.another')}
          </button>
          <a href="/" className="bg-blue-600 text-white px-8 py-3 rounded-full font-bold hover:bg-blue-700 transition-all hover:scale-105">{t('registration.backHome')}</a>
        </div>
      </div>
    );
  }
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-[40px] shadow-2xl p-6 md:p-8 lg:p-12 space-y-8 md:space-y-12">
          ...
          <div className="space-y-8">
            <h3 className="text-2xl font-bold text-gray-800 flex items-center gap-3">
              <span className="w-8 h-8 bg-blue-100 text-blue-600 rounded-lg flex items-center justify-center text-sm animate-pulse">1</span>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input 
                  ...
                  className="w-full bg-gray-50 border border-gray-200 rounded-2xl px-5 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                />
              </div>
              <div className="space-y-2">
                ...
                {CATEGORIES.map(cat => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-full text-xs font-semibold transition-all ${
                      ...
                      : 'bg-gray-50 text-gray-600 border border-gray-200 hover:border-blue-500'
                    }`}
                  >
                    {cat}
                  </button>
          ...
          <div className="space-y-8">
            <h3 className="text-2xl font-bold text-gray-800 flex items-center gap-3">
              <span className="w-8 h-8 bg-blue-100 text-blue-600 rounded-lg flex items-center justify-center text-sm animate-pulse">2</span>
            ...
            <div className="space-y-2">
              ...
              <textarea 
                ...
                className="w-full bg-gray-50 border border-gray-200 rounded-2xl px-5 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all resize-none"
              ></textarea>
            </div>
          ...
          <div className="space-y-8">
            <h3 className="text-2xl font-bold text-gray-800 flex items-center gap-3">
              <span className="w-8 h-8 bg-blue-100 text-blue-600 rounded-lg flex items-center justify-center text-sm animate-pulse">3</span>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-4">
                ...
                <div className="border-2 border-dashed border-gray-200 rounded-3xl p-8 text-center hover:border-blue-500 transition-colors cursor-pointer group">
          ...
          <div className="space-y-8">
            <h3 className="text-2xl font-bold text-gray-800 flex items-center gap-3">
              <span className="w-8 h-8 bg-blue-100 text-blue-600 rounded-lg flex items-center justify-center text-sm animate-pulse">4</span>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input required type="email" value={formData.email} onChange={e => setFormData({...formData, email: e.target.value})} className="w-full bg-gray-50 border border-gray-200 rounded-2xl px-5 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500" />
              </div>
              <div className="space-y-2">
          ...
          <button 
            type="submit"
            className="w-full bg-blue-600 text-white py-5 rounded-[20px] font-bold text-lg shadow-xl hover:bg-blue-700 hover:-translate-y-1 transition-all active:scale-95 hover:scale-105"
          >
