            ...
            <div className="bg-white rounded-[40px] p-6 md:p-8 lg:p-12 shadow-sm border border-gray-100 h-full">
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  {artisan.instagram && (
                    <a href={artisan.instagram} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-600 hover:text-pink-600 transition-all p-4 bg-gray-50 rounded-2xl group">
                      ...
                      <div>
                        ...
                        <p className="font-semibold">@{artisan.slug}</p>
                      </div>
                    </a>
                  )}
