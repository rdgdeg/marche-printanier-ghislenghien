  ...
  if (!artisan) {
    return (
      <div className="py-32 text-center">
        ...
        <Link to="/artisans" className="bg-blue-600 text-white px-8 py-3 rounded-full font-bold">Retour à l'annuaire</Link>
      </div>
    );
  }
        ...
        <div className="max-w-7xl mx-auto px-4 flex justify-between items-center">
          ...
          <button 
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-full font-bold text-sm transition-all ${
              copySuccess ? 'bg-blue-100 text-blue-700' : 'bg-gray-50 text-gray-700 hover:bg-blue-50'
            }`}
          >
            ...
            <div className="bg-white rounded-[40px] p-6 md:p-8 lg:p-12 shadow-sm border border-gray-100 h-full">
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col gap-3">
                  {artisan.email && (
                    <a href={`mailto:${artisan.email}`} className="flex items-center gap-3 text-gray-600 hover:text-blue-600 transition-all p-4 bg-gray-50 rounded-2xl group">
                  ...
                  {artisan.telephone && (
                    <a href={`tel:${artisan.telephone.replace(/\s/g, '')}`} className="flex items-center gap-3 text-gray-600 hover:text-blue-600 transition-all p-4 bg-gray-50 rounded-2xl group">
                      <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center shadow-sm group-hover:bg-blue-600 group-hover:text-white transition-all">
                  ...
                  {artisan.facebook && (
                    <a href={artisan.facebook.startsWith('http') ? artisan.facebook : `https://facebook.com/${artisan.facebook.replace('@', '')}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-600 hover:text-blue-600 transition-all p-4 bg-gray-50 rounded-2xl group">
                      <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center shadow-sm group-hover:bg-blue-600 group-hover:text-white transition-all">
                        <span className="text-lg">👥</span>
                      </div>
                      <div>
                  ...
                  {artisan.site && (
                    <a href={artisan.site} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-600 hover:text-blue-600 transition-all p-4 bg-gray-50 rounded-2xl group">
                      <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center shadow-sm group-hover:bg-blue-600 group-hover:text-white transition-all">
