    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <section className="bg-white py-16 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6 animate-fade-in-up">{t('artisans.title')} <span className="text-blue-600">{t('artisans.titleHighlight')}</span></h1>
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
            <div className="relative w-full lg:max-w-md">
              <input 
                ...
                className="w-full bg-gray-50 border border-gray-200 rounded-2xl pl-12 pr-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all"
              />
      ...
      <section className="max-w-7xl mx-auto px-4 py-12">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-lg font-bold text-gray-800">
            {filteredArtisans.length} {filteredArtisans.length > 1 ? t('artisans.found', { count: String(filteredArtisans.length) }) : t('artisans.foundOne', { count: String(filteredArtisans.length) })}
          </h2>
        </div>
        ...
        {filteredArtisans.length > 0 ? (
          ...
          <div className="py-24 text-center">
            ...
            <button 
              ...
              className="mt-6 text-blue-600 font-bold hover:underline hover-lift"
            >
              {t('artisans.reset')}
            </button>
          </div>
