...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    'home.subtitle': 'Le Marché Printanier de Ghislenghien revient pour célébrer la créativité locale. Rejoignez-nous pour une journée inoubliable.',
    ...
    'registration.social': 'Instagram / Facebook',
  ...
  nl: {
    ...
    'home.subtitle': 'De Lente Markt van Ghislenghien keert terug om lokale creativiteit te vieren. Sluit je bij ons aan voor een onvergetelijke dag.',
